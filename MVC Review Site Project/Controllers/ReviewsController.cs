...
namespace MVC_Review_Site_Project.Controllers
{
    public class ReviewsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,PublishDate,Rating,Description,CategoryID")] Review review)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,PublishDate,Rating,Description,CategoryID")] Review review)
        {
            if (ModelState.IsValid)
            {
